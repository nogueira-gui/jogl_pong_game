...
public class PongGameHandler implements Runnable {
    ...
    public PongGameHandler(Player player1, Player player2) {
        this.player1 = player1;
        this.player2 = player2;

        players.add(player1);
        players.add(player2);
//        initialize ball in the center of screen
        ball = new Ball(0, 0);
    }
    ...
    public void play() {
        ...
        for (Player p : players) {
            p.sendMessage("Ball position: (" + ball.getX() + ", " + ball.getY() + ")");
        }
